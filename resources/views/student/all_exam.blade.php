              ...
              <table id="order-listing" class="table table-bordered">
                ...
                <tbody>
                  ...
                  <tr>
                      ...
                      <td>
                        @php
                            $mcq = DB::table('mcq_marks')->where('mcq_marks_question_id',$question->id)->where('mcq_marks_user_id',Auth::user()->id)->first();
                        @endphp
                            @if ($mcq)
                            MCQ - {{$mcq->mcq_marks_total}} <br>
                            @else
                            MCQ - Absent <br>
                            @endif
                        @endif
                        ...
                        @php
                            $wrt = DB::table('written_marks')->where('written_marks_question_id',$question->id)->where('written_marks_user_id',Auth::user()->id)->first();
                        @endphp

                            @if ($wrt)
                            Written - {{$wrt->written_marks_total}} <br>
                            @else
                            Written - Absent <br>
                            @endif
                      </td>
